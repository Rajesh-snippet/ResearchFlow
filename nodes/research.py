...
M5.6:
- Uses invoke_with_retry() for structured extraction.
- Stronger prompt enforcing the EvidencePack JSON schema.
"""
...
Given raw web search results, produce a valid EvidencePack.
...
- NEVER wrap it inside {"items": [...]}
- NEVER invent additional wrapper objects.
- Only include items with a non-empty URL.
- Prefer authoritative and relevant sources.
- Normalize published_at to YYYY-MM-DD only if explicitly available.
- Otherwise use null.
- Never guess dates.
